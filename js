...
<body link="#0000cc">
            ...
            <div class="head_wrapper">
                <div class="s_form">
                    <div class="s_form_wrapper">
                        <a href="//www..com/" id="result_logo"><img src="//www..com/img/_jgylogo3.gif" alt="到百度首页" title="到百度首页"></a>
                        <form id="form" name="f" action="//www..com/s" class="fm">
                            <input type="hidden" name="ie" value="utf-8">
                            <input type="hidden" name="f" value="8">
                            <input type="hidden" name="rsv_bp" value="1">
                            <input type="hidden" name="ch" value="">
                            <input type="hidden" name="tn" value="err">
    ...
    <div class="s_tab" id="s_tab">
        <b>网页</b>
        <a href="http://tieba..com/f?kw=&fr=wwwt" wdfield="kw">贴吧</a>
        <a href="http://zhidao..com/q?ct=17&pn=0&tn=ikaslist&rn=10&word=&fr=wwwt" wdfield="word">知道</a>
        <a href="http://music..com/search?fr=ps&ie=utf-8&key=" wdfield="key">音乐</a>
        <a href="http://image..com/i?tn=image&ps=1&ct=201326592&lm=-1&cl=2&nc=1&ie=utf-8&word=" wdfield="word">图片</a>
        <a href="http://v..com/v?ct=301989888&rn=20&pn=0&db=0&s=25&ie=utf-8&word=" wdfield="word">视频</a>
        <a href="http://map..com/m?word=&fr=ps01000" wdfield="word">地图</a>
        <a href="http://wenku..com/search?word=&lm=0&od=0&ie=utf-8" wdfield="word">文库</a>
        <a href="//www..com/more/">更多»</a>
    </div>
        ...
        <div id="content_left">
            <div class="nors">
                <div class="norsSuggest">
                    ...
                    <ol>
                        <li>请检查您访问的网址是否正确</li>
                        <li>如果您不能确认访问的网址，请浏览<a href="//www..com/more/index.html">百度更多</a>页面查看更多网址。</li>
                        <li>回到顶部重新发起搜索</li>
                        <li>如有任何意见或建议，请及时<a href="http://qingting..com/index">反馈给我们</a>。</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div id="foot">
        <span id="help" style="float:left;padding-left:121px">
            <a href="http://help..com/question" target="_blank">帮助</a>
            <a href="http://www..com/search/jubao.html" target="_blank">举报</a>
            <a href="http://jianyi..com" target="_blank">给百度提建议</a>
        </span>
    </div>
</body>
<script>
(function () {
        var LOGURL = 'https://sp1..com/5b1ZeDe5KgQFm2e88IuM_a/cm.gif';
    ...
    (function () {
        if(window.recommend && window.recommend.query && window.recommend.query.length > 0) {
            ...
            for(var i = 1; i < (queryArray.length+1); i++) {
                itemUrl = '//www..com/s?word=' + encodeURIComponent(queryArray[i-1].word) + '&sa=' + queryArray[i-1].sa + '&tn=' + queryArray[i-1].tn;
            ...
            recommendHtml += '</tbody></table><div class="opr-toplist-info"><span>来源：</span><a target="_blank" href="http://www..com/link?url=sLR63PtaB7kc3YkTtzDy1k3mbTm1DXDMu-nLcijZx8DmWgOff4lBxqmY-LGDyHqw">百度风云榜</a><span>&nbsp;-&nbsp;</span><a target="_blank" href="http://www..com/link?url=01vNBVXR2eaJxETl9PI3hcrvKCcwaJIKk5FkpO7l5YI_Q_pC24ogIBoZxI0LAu5oYpAdhRH42nzxAqfui0YnHK">实时热点</a></div></div>';
